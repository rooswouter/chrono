...
// =============================================================================
//
// Brake Advanced for wheeled vehicles modeled using a clutch between two shafts.
// Adds getters for ABS controller
// todo: Pressure brake force
// todo: Temperature and fading effects
//
// =============================================================================
...
#include "chrono_vehicle/wheeled_vehicle/brake/ChShaftsBrake.h"
...
namespace chrono {
    namespace vehicle {
        ...
        class CH_VEHICLE_API ChBrakeShaftsAdvanced : public ChBrakeShafts
        {
        public:
            ...
            virtual std::string GetTemplateName() const override { return "BrakeShaftsAdvanced"; }
